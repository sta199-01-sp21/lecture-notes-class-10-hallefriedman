...
- What is the probability a randomly selected patient received the placebo
  and the treatment?
  0/84; it's a disjoint probability
...
Probability that you get a blue marble is 3/8 and for white, it would be 1/8.
...
Very close; as we increase the sample size, the probability is going to get closer and closer.
...
match?
First we added a draw, and then we created a variable to see if the draws would match up. 
```{r identify_matches}
